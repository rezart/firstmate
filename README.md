...
- [docs/project-director.md](docs/project-director.md) - the Project Director loop for multi-task projects: state formats, the task DAG, dispatch, gap cycles, and role-based runtime selection.
