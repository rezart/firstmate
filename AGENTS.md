...
- `project-management` - load before adding, creating, removing, or initializing a project.
  Cloning or registering a project is add intake and uses the same trigger.
- `project-director` - load when the captain asks for a whole project to be planned, decomposed, executed, and verified end to end rather than a single task, and when resuming, reviewing, or replanning such a project.
